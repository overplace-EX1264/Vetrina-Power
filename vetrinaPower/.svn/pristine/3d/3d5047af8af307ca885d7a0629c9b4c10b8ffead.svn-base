	...
	_this.listModuli = [
		...
		},
		{
			...
			longDescription: 'Grazie al modulo Promozioni, Overplace ti offre la possibilit&agrave; di mettere a disposizione dei tuoi clienti e visitatori sconti incrementali e offerte fidelizzanti. '+
							...
							'In combinazione al modulo Messaggi e Social, l&apos;App myOverplace ti da la possibilit&agrave; di pubblicizzare la tua Offerta promozionale anche sui Social network Facebook e Twitter e di utilizzarla come oggetto per nuove campagne di email e sms marketing. '+
        ...
        },
		{
			...
			longDescription: 'Attraverso il modulo Coupon potrai creare strepitosi Deal da proporre ai visitatori delle tue piattaforme online. La formula Coupon Overplace &egrave; unica, a differenza delle altre piattaforme online, infatti, non prevede il pagamento anticipato da parte dell&apos;utente. '+
							...
							'Attraverso l&apos;App myOverplace potrai creare velocemente le tue offerte Coupon, controllarne lo stato di validazione e ricevere una notifica ogni volta che un utente richiede il tuo Deal. '+
							'In combinazione al modulo Messaggi e Social, l&apos;App myOverplace ti da la possibilit&agrave; di pubblicizzare il tuo Coupon anche sui Social network Facebook e Twitter e di utilizzarla come oggetto per nuove campagne di email e sms marketing. ',
			detail: {
				vantage: [
		...
		},
		{
			...
			longDescription: 'Consulta le recensioni ricevute dal tuo sito e dalla tua Vetrina Virtuale, rispondi ai commenti degli utenti e aumenta l&apos;engagement prodotto dalle tue piattaforme online. '+
							'L&apos;App myOverplace ti invier&agrave; una notifica ogni qual volta la tua attivit&agrave; ricever&agrave; una recensione, dandoti la possibilit&agrave; di inserire una risposta o un ringraziamento con pochi semplici gesti. '+
		...
		},
		{
			...
			longDescription: 'Grazie all&apos;app myOverplace potrai scattare una foto o scegliere un&apos;immagine dalla tua galleria e condividerla con il Web Media Center in pochi istanti. '+
